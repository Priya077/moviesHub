                            ...
                            <ul class="list-group favourites-genres">
                                {
                                    this.state.genres.map((genre)=>(
                                        ...
                                        <li class="list-group-item" style={{background:'blue',color:'yellow',fontWeight:'white'}} >{genre}</li> :
                                        <li class="list-group-item" style={{background:'white',color:'blue'}} onClick={()=>this.handleGenreChange(genre)}>{genre}</li>
                                    ))
                                }
                            </ul>
                            </div>
